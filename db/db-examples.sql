-- mysql client: käynnistys komentoriviltä: mysql -u root -p
...
-- WEEK 3 TEHTAVA - Create a table for activity
...
-- WEEK 3 TEHTAVA - Inserting multiple activities
INSERT INTO Activities (user_id, activity_date, activity_type, duration_minutes, created_at) VALUES
  (1, '2024-01-10', 'Basketball', 60, '2024-01-10 20:00:00'),
  (1, '2024-01-11', 'Football', 45, '2024-01-11 20:00:00'),
  (2, '2024-01-10', 'Gym', 30, '2024-01-10 21:00:00');
